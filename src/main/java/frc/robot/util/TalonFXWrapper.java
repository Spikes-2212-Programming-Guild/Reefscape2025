...
public class TalonFXWrapper implements SmartMotorController {
    ...
    /**
     * Constructs a new instance of {@link com.spikes2212.util.smartmotorcontrollers.TalonFXWrapper}.
     *
    ...
    public void setUpdateFrequency(int frequencyHz) {
        setPositionUpdateFrequency(frequencyHz);
        setVelocityUpdateFrequency(frequencyHz);
    }

    public void setPositionUpdateFrequency(int frequencyHz) {
        talonFX.getPosition().setUpdateFrequency(frequencyHz);
    }

    public void setVelocityUpdateFrequency(int frequencyHz) {
        talonFX.getVelocity().setUpdateFrequency(frequencyHz);
    }
